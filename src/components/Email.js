...
const Email = ({ expeditor, messageTitle, message, timestamp }) => {
  return (
    <div className="flex justify-between items-center border-b py-[1px] px-1 lg:px-4 text-[14px] hover:bg-[#EAF1FB] hover:shadow-md hover:border hover:font-semibold duration-100 cursor-pointer">
      <div className="hidden sm:w-[3rem] -ml-1 text-gray-400 md:flex gap-1 cursor-pointer">
        <div className="p-1 text-gray-400 rounded-full hover:bg-gray-200 duration-150 cursor-pointer">
          <input type="checkbox" />
        </div>
        <div className="flex items-center p-1 text-gray-400 rounded-full hover:text-yellow-500 hover:bg-gray-200 duration-150 cursor-pointer">
