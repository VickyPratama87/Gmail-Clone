...
const Email = ({ expeditor, messageTitle, message, timestamp }) => {
  return (
    <>
      <div className="flex justify-between items-center border-b py-[1px] px-1 lg:px-4 text-[14px] hover:bg-[#EAF1FB] hover:shadow-sm hover:border hover:font-semibold duration-100 cursor-pointer">
